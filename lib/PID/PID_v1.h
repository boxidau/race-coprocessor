// Taken from r3ttb/PID@^1.2.1 with some fixes applied:
// 1. switch to floats (for performance)
// 2. do not check sample time in ::Compute() since it will introduce jitter problems
// 3. don't floor `outputSum` to the minimum output value if it's above zero.
